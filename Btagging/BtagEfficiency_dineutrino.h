...
Double_t BTagMCEffBinsPt[10] = {20., 30., 50., 70., 100., 140., 200., 300., 600., 1000.};
TH2F* histM_b_total_      = new TH2F("histM_b_total_",      "histM_b_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histM_b_passing_    = new TH2F("histM_b_passing_",    "histM_b_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histM_c_total_      = new TH2F("histM_c_total_",      "histM_c_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histM_c_passing_    = new TH2F("histM_c_passing_",    "histM_c_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histM_udsg_total_   = new TH2F("histM_udsg_total_",   "histM_udsg_total_",   1,20,1000, 1,0,2.4);
TH2F* histM_udsg_passing_ = new TH2F("histM_udsg_passing_", "histM_udsg_passing_", 1,20,1000, 1,0,2.4);
TH2F* histL_b_total_      = new TH2F("histL_b_total_",      "histL_b_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histL_b_passing_    = new TH2F("histL_b_passing_",    "histL_b_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histL_c_total_      = new TH2F("histL_c_total_",      "histL_c_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histL_c_passing_    = new TH2F("histL_c_passing_",    "histL_c_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histL_udsg_total_   = new TH2F("histL_udsg_total_",   "histL_udsg_total_",   1,20,1000, 1,0,2.4);
TH2F* histL_udsg_passing_ = new TH2F("histL_udsg_passing_", "histL_udsg_passing_", 1,20,1000, 1,0,2.4);
TH2F* histT_b_total_      = new TH2F("histT_b_total_",      "histT_b_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histT_b_passing_    = new TH2F("histT_b_passing_",    "histT_b_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histT_c_total_      = new TH2F("histT_c_total_",      "histT_c_total_",      9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histT_c_passing_    = new TH2F("histT_c_passing_",    "histT_c_passing_",    9, BTagMCEffBinsPt, 1,0,2.4);
TH2F* histT_udsg_total_   = new TH2F("histT_udsg_total_",   "histT_udsg_total_",   1,20,1000, 1,0,2.4);
TH2F* histT_udsg_passing_ = new TH2F("histT_udsg_passing_", "histT_udsg_passing_", 1,20,1000, 1,0,2.4);

//BTAG SF
/*BTagCalibration calib("CSVv2", "SF/CSVv2Moriond17_2017_1_26_BtoH.csv");
...
TFile *fileNewPU         = new TFile("SF_dineutrino/PileUpReweighting2017.root");
