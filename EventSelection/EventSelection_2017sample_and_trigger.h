...
void SelectCA8Jets(int CA8jetType, vector<TLorentzVector> & SelectedWJets, vector<TLorentzVector> SelectedElectrons, vector<TLorentzVector> SelectedMuons, vector<int> & CA8Indices, 
		int SysJes, int SysJer, bool data);
/*void SelectZBoson(bool &SelectedZBoson, vector<TLorentzVector> & SelectedZJets, vector<TLorentzVector> & SelectedTopJets, TLorentzVector &ZBoson,vector<int> CA8Indices,float &ZMass_
	,bool & FullyMerged, bool &PartiallyMerged, bool &ResolvedEvent, TLorentzVector &TopQuarkMerged, TLorentzVector &TopQuarkPartial, TLorentzVector &TopQuarkResolved);
void SelectJets(int jetType, vector<TLorentzVector> & SelectedJets, vector<float> & SelectedJetsCSV,int SysJes, int SysJer, bool data);
void SelectCA8Jets(int CA8jetType,vector<TLorentzVector> & SelectedCA8Jets,vector<int> & CA8Indices, 
		   int SysJes, int SysJer, bool data);*/
...
void get_weight_btag(int selection, float &w_Btag, float &w_BtagUp, float &w_BtagDown, float &w_BtagLoose, float &w_BtagLooseUp, float &w_BtagLooseDown, string fileName2);
...
//float HTcalculator(int SysJes, int SysJer);
...
//void FillBranches(bool ResolvedEvent,bool PartiallyMerged,bool FullyMerged,TLorentzVector TopQuark,bool BprimeEvent,float BQuarkCSV,TLorentzVector BQuarkBprime,bool SelectedZBoson,TLorentzVector ZBoson,TLorentzVector Tprime,TLorentzVector Bprime,TLorentzVector TopQuarkResolved,TLorentzVector Jet1Resolved,TLorentzVector Jet2Resolved,TLorentzVector Jet3Resolved,TLorentzVector TprimeResolved,TLorentzVector TopQuarkPartial,TLorentzVector Jet1Partial,TLorentzVector Jet2Partial,TLorentzVector TprimePartial,float WMass_,float WSubjet_,TLorentzVector TopQuarkMerged,TLorentzVector TprimeMerged,float TopSoftMass_,float TopSubjet_,vector<TLorentzVector> SelectedForwardJets,vector<TLorentzVector> SelectedBJets,float ZMass_);
//BTAG SF
//BTagCalibration calib("CSVv2", "/eos/user/t/tayu/SF/CSVv2_Moriond17_B_H.csv");
...
//Lepton SF
//TFile *fileForwardJet    = new TFile("/eos/user/t/tayu/SF/ForwardJetSFFinal.root");
/*TFile *fileMuonSF1id     = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_BCDEF.root");
TFile *fileMuonSF1iso    = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_BCDEF_ISO.root");
TFile *fileMuonSF2id     = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_GH.root");
TFile *fileMuonSF2iso    = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_GH_ISO.root");
TFile *fileMuonTrig1     = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_RunBtoF.root");
TFile *fileMuonTrig2     = new TFile("/eos/user/t/tayu/SF/EfficienciesAndSF_Period4.root");
TFile *fileMuonTrack1    = new TFile("/eos/user/t/tayu/SF/fitsBCDEF.root");
TFile *fileMuonTrack2    = new TFile("/eos/user/t/tayu/SF/fitsGH.root");
TFile *fileElectron1     = new TFile("/eos/user/t/tayu/SF/egammaEffi.txt_EGM2D_1_Moriond.root");
TFile *fileElectron2     = new TFile("/eos/user/t/tayu/SF/egammaEffi.txt_EGM2D_2_Moriond.root");
TFile *fileElectronTrig  = new TFile("/eos/user/t/tayu/SF/ElectronTriggerSF.root");
TFile *fileOldPU         = new TFile("/eos/user/t/tayu/SF/PileUpReweighting2016.root");
TFile *fileNewPU         = new TFile("/eos/user/t/tayu/SF/MyDataPileupHistogram_69200.root");
TFile *fileNewPUUp       = new TFile("/eos/user/t/tayu/SF/MyDataPileupHistogram_69200Up.root");
TFile *fileNewPUDo       = new TFile("/eos/user/t/tayu/SF/MyDataPileupHistogram_69200Do.root");*/
/*TH2F  *histoForwardJet   = (TH2F*)fileForwardJet->Get("histo");
TH2F  *histoMuonSF1id    = (TH2F*)fileMuonSF1id->Get("MC_NUM_TightID_DEN_genTracks_PAR_pt_eta/abseta_pt_ratio");
TH2F  *histoMuonSF1iso   = (TH2F*)fileMuonSF1iso->Get("TightISO_TightID_pt_eta/abseta_pt_ratio");
TH2F  *histoMuonSF2id    = (TH2F*)fileMuonSF2id->Get("MC_NUM_TightID_DEN_genTracks_PAR_pt_eta/abseta_pt_ratio");
TH2F  *histoMuonSF2iso   = (TH2F*)fileMuonSF2iso->Get("TightISO_TightID_pt_eta/abseta_pt_ratio");
TH2F  *histoMuonTrig1    = (TH2F*)fileMuonTrig1->Get("IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio");
TH2F  *histoMuonTrig2    = (TH2F*)fileMuonTrig2->Get("IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio");
TGraphAsymmErrors  *histoMuonTrack1   = (TGraphAsymmErrors*)fileMuonTrack1->Get("ratio_eff_aeta_dr030e030_corr");
TGraphAsymmErrors  *histoMuonTrack2   = (TGraphAsymmErrors*)fileMuonTrack2->Get("ratio_eff_aeta_dr030e030_corr");
TH2F  *histoMuonSF       = (TH2F*)fileMuonSF->Get("IsoMu27_PtEtaBins/abseta_pt_ratio");
...
//TFile *fileOldPU         = new TFile("/afs/cern.ch/work/a/aspiezia/Ntuplizer/2017/CMSSW_9_4_0/src/BSMFramework/BSM3G_TNT_Maker/data/PUReweight/PileUpReweighting2017.root");
TFile *fileNewPU         = new TFile("SF_2017/PileUpReweighting2017.root");
