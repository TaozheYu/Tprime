...
void SelectCA8Jets(int CA8jetType, vector<TLorentzVector> & SelectedWJets, vector<TLorentzVector> SelectedElectrons, vector<TLorentzVector> SelectedMuons, vector<int> & CA8Indices, int SysJes, int SysJer, bool data, bool &deltaPhiJetMet);
...
//BTAG SF
BTagCalibration calib("CSVv2", "SF_dineutrino_2018/DeepCSV_102XSF_V1.csv");
...
TFile *fileOldPU         = new TFile("SF_dineutrino_2018/PileUpReweighting2017.root");
TFile *fileNewPU         = new TFile("SF_dineutrino_2018/PileUpReweighting2017_v1.root");
TFile *fileNewPUUp       = new TFile("SF_dineutrino_2018/PileUpReweighting2017Up.root");
TFile *fileNewPUDo       = new TFile("SF_dineutrino_2018/PileUpReweighting2017Do.root");
TFile *fileZPt           = new TFile("SF_dineutrino_2018/scalefactors_v4.root");
TFile *fileHT_SF         = new TFile("SF_dineutrino_2018/HT_SF_v3.root");
TFile *fileTrig          = new TFile("SF_dineutrino_2018/2DTrigger_SingleElectron_2018.root");
//TFile *fileHT_SF         = new TFile("SF_dineutrino/HT_SF_veto.root");
