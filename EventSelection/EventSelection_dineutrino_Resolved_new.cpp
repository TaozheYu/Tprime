#include "EventSelection_dineutrino_Resolved_new.h" 
#include "math.h"

void EventSelection_dineutrino_Resolved_new(const char * Input = ""){
  ...
  for(unsigned int Nfiles=0; Nfiles<fileName.size(); Nfiles++){
    string NewFileprov;
    if ((SysJes==0)&&(SysJer==0)) NewFileprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/Selection_new/"+fileName[Nfiles];
	if ((SysJes==1)&&(SysJer==0)) NewFileprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/Selection_new/JESup/"+fileName[Nfiles];
	if ((SysJes==2)&&(SysJer==0)) NewFileprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/Selection_new/JESdo/"+fileName[Nfiles];
	if ((SysJes==0)&&(SysJer==1)) NewFileprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/Selection_new/JERup/"+fileName[Nfiles];
	if ((SysJes==0)&&(SysJer==2)) NewFileprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/Selection_new/JERdo/"+fileName[Nfiles];
    ...
    string FILEprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/data_and_sample_2017/"+fileName[Nfiles];
...
void get_weight_btag(int selection, float &w_Btag, float &w_BtagUp, float &w_BtagDown, float &w_Btag1Up, float &w_Btag1Down, float &w_Btag2Up, float &w_Btag2Down, float &w_BtagLoose, float &w_BtagLooseUp, float &w_BtagLooseDown, string fileName){
  string FILEprov = "/publicfs/cms/user/yutz/Tprime/2017_dineutrino/BtagEfficiency_new/"+fileName;
  const char *FILE = FILEprov.c_str();
