...
void SelectJets(int region, int jetType,vector<TLorentzVector> & SelectedJets, vector<float> & SelectedJetsCSV, vector<TLorentzVector> SelectedElectrons, vector<TLorentzVector> SelectedMuons, 
		int SysJes, int SysJer, bool data, bool &deltaPhiJetMet);
void SelectCA8Jets(int region, int CA8jetType, vector<TLorentzVector> & SelectedWJets, vector<TLorentzVector> SelectedElectrons, vector<TLorentzVector> SelectedMuons, vector<int> & CA8Indices, 
		int SysJes, int SysJer, bool data, bool &deltaPhiJetMet);
...
TFile *fileHT_SF         = new TFile("SF_dineutrino/HT_SF_v3.root");
