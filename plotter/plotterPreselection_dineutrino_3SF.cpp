 ...
 // name.push_back("Jet1ResolvedPt"); bin.push_back(18);     Min.push_back(0);    Max.push_back(900);    axis.push_back("jet1(resolved) pt [GeV]");
  ...
  for(int i=0; i<name.size(); i++){
   ...
   for(int j=0; j<N-1; j++){
	...
	if(SF3>0) SF3_h->SetBinContent(j+1,SF3);

	SF1_h->SetBinError(j+1,SF1_err);
	SF2_h->SetBinError(j+1,SF2_err);
	SF3_h->SetBinError(j+1,SF3_err);
	
	MakeHistos(CUTPre, plot,bin[i],Min[i],Max[i],0,
		       SF1,SF2,SF3,SF1_err,SF2_err,SF3_err,
		       data,background, 
			   ZToNuNu,QCD,WToLNu,TT,ST,VV,
			   tptzm0700lh,tptzm0900lh,tptzm1400lh,tptzm1700lh);
	...
	tptzm0700lh_PRE->SetLineWidth(2); tptzm0900lh_PRE->SetLineWidth(2); tptzm1400lh_PRE->SetLineWidth(2); tptzm1700lh_PRE->SetLineWidth(2); 
	...
	QCD_PRE->SetLineWidth(2);//QCD_1_SR->SetLineWidth(2); QCD_2_SR->SetLineWidth(2);QCD_3_SR->SetLineWidth(2); QCD_4_SR->SetLineWidth(2); QCD_5_SR->SetLineWidth(2); QCD_6_SR->SetLineWidth(2); QCD_7_SR->SetLineWidth(2);
	...
	ST_PRE->SetLineWidth(2); //ST_1_SR->SetLineWidth(2); ST_2_SR->SetLineWidth(2); ST_3_SR->SetLineWidth(2); ST_4_SR->SetLineWidth(2); 
	VV_PRE->SetLineWidth(2); //ZZ1_SR->SetLineWidth(2); ZZ2_SR->SetLineWidth(2); ZZ3_SR->SetLineWidth(2); WW1_SR->SetLineWidth(2); WW2_SR->SetLineWidth(2); WZ1_SR->SetLineWidth(2); WZ2_SR->SetLineWidth(2); WZ3_SR->SetLineWidth(2);
	
	tptzm1700lh_PRE->SetLineStyle(2); tptzm0700lh_PRE->SetLineColor(2); tptzm0900lh_PRE->SetLineColor(2); tptzm1400lh_PRE->SetLineColor(2); tptzm1700lh_PRE->SetLineColor(2); 
	...
	QCD_PRE->SetLineColor(kGreen-3); //QCD_1_SR->SetLineColor(kGreen-3); QCD_2_SR->SetLineColor(kGreen-3);QCD_3_SR->SetLineColor(kGreen-3); QCD_4_SR->SetLineColor(kGreen-3); QCD_5_SR->SetLineColor(kGreen-3); QCD_6_SR->SetLineColor(kGreen-3); QCD_7_SR->SetLineColor(kGreen-3);
	...
	ST_PRE->SetLineColor(kGreen+3); //ST_1_SR->SetLineColor(kGreen+3); ST_2_SR->SetLineColor(kGreen+3); ST_3_SR->SetLineColor(kGreen+3); ST_4_SR->SetLineColor(kGreen+3); 
	VV_PRE->SetLineColor(kCyan+2); //ZZ1_SR->SetLineColor(kCyan+2); ZZ2_SR->SetLineColor(kCyan+2); ZZ3_SR->SetLineColor(kCyan+2); WW1_SR->SetLineColor(kCyan+2); WW2_SR->SetLineColor(kCyan+2); WZ1_SR->SetLineColor(kCyan+2); WZ2_SR->SetLineColor(kCyan+2); WZ3_SR->SetLineColor(kCyan+2); 
	...
	QCD_PRE->SetFillColor(kGreen-3); //QCD_1_SR->SetFillColor(kGreen-3); QCD_2_SR->SetFillColor(kGreen-3);QCD_3_SR->SetFillColor(kGreen-3); QCD_4_SR->SetFillColor(kGreen-3); QCD_5_SR->SetFillColor(kGreen-3); QCD_6_SR->SetFillColor(kGreen-3); QCD_7_SR->SetFillColor(kGreen-3);
	...
	ST_PRE->SetFillColor(kGreen+3); //ST_1_SR->SetFillColor(kGreen+3); ST_2_SR->SetFillColor(kGreen+3); ST_3_SR->SetFillColor(kGreen+3); ST_4_SR->SetFillColor(kGreen+3); 
	VV_PRE->SetFillColor(kCyan+2); //ZZ1_SR->SetFillColor(kCyan+2); ZZ2_SR->SetFillColor(kCyan+2); ZZ3_SR->SetFillColor(kCyan+2); WW1_SR->SetFillColor(kCyan+2); WW2_SR->SetFillColor(kCyan+2); WZ1_SR->SetFillColor(kCyan+2); WZ2_SR->SetFillColor(kCyan+2); WZ3_SR->SetFillColor(kCyan+2); 
	
	data_PRE->SetLineWidth(2); data_PRE->SetLineColor(1); data_PRE->SetMarkerColor(1); data_PRE->SetMarkerStyle(20); data_PRE->SetMarkerSize(1.3);

    Double_t dataErr   = 0; Float_t dataYield = data_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX()-1,dataErr,"");
    /*Double_t ZToNuNu_1Err   = 0; Float_t ZToNuNu_1Yield = ZToNuNu_1_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_1Err,"");
    Double_t ZToNuNu_2Err   = 0; Float_t ZToNuNu_2Yield = ZToNuNu_2_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_2Err,"");
    Double_t ZToNuNu_3Err   = 0; Float_t ZToNuNu_3Yield = ZToNuNu_3_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_3Err,"");
    Double_t ZToNuNu_4Err   = 0; Float_t ZToNuNu_4Yield = ZToNuNu_4_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_4Err,"");
	Double_t ZToNuNu_5Err   = 0; Float_t ZToNuNu_5Yield = ZToNuNu_5_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_5Err,"");
	Double_t ZToNuNu_6Err   = 0; Float_t ZToNuNu_6Yield = ZToNuNu_6_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_6Err,"");
	Double_t ZToNuNu_7Err   = 0; Float_t ZToNuNu_7Yield = ZToNuNu_7_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_7Err,"");*/
	Double_t ZToNuNu_Err   = 0; Float_t ZToNuNu_Yield = ZToNuNu_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZToNuNu_Err,"");
	/*Double_t QCD_1Err   = 0; Float_t QCD_1Yield = QCD_1_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_1Err,"");
    Double_t QCD_2Err   = 0; Float_t QCD_2Yield = QCD_2_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_2Err,"");
    Double_t QCD_3Err   = 0; Float_t QCD_3Yield = QCD_3_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_3Err,"");
    Double_t QCD_4Err   = 0; Float_t QCD_4Yield = QCD_4_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_4Err,"");
	Double_t QCD_5Err   = 0; Float_t QCD_5Yield = QCD_5_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_5Err,"");
	Double_t QCD_6Err   = 0; Float_t QCD_6Yield = QCD_6_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_6Err,"");
	Double_t QCD_7Err   = 0; Float_t QCD_7Yield = QCD_7_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_7Err,"");*/
	Double_t QCD_Err   = 0;  Float_t QCD_Yield = QCD_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),QCD_Err,"");
    /*Double_t WToLNu_1Err = 0; Float_t WToLNu_1Yield = WToLNu_1_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_1Err,"");
	Double_t WToLNu_2Err = 0; Float_t WToLNu_2Yield = WToLNu_2_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_2Err,"");
	Double_t WToLNu_3Err = 0; Float_t WToLNu_3Yield = WToLNu_3_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_3Err,"");
	Double_t WToLNu_4Err = 0; Float_t WToLNu_4Yield = WToLNu_4_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_4Err,"");
	Double_t WToLNu_5Err = 0; Float_t WToLNu_5Yield = WToLNu_5_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_5Err,"");
	Double_t WToLNu_6Err = 0; Float_t WToLNu_6Yield = WToLNu_6_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_6Err,"");
	Double_t WToLNu_7Err = 0; Float_t WToLNu_7Yield = WToLNu_7_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_7Err,"");*/
	Double_t WToLNu_Err = 0; Float_t WToLNu_Yield = WToLNu_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WToLNu_Err,"");
    /*Double_t TT_1Err = 0; Float_t TT_1Yield = TT_1_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),TT_1Err,"");
	Double_t TT_2Err = 0; Float_t TT_2Yield = TT_2_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),TT_2Err,"");*/
	Double_t TT_Err = 0; Float_t TT_Yield = TT_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),TT_Err,"");
    /*Double_t ST_1Err = 0; Float_t ST_1Yield = ST_1_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ST_1Err,"");
	Double_t ST_2Err = 0; Float_t ST_2Yield = ST_2_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ST_2Err,"");
	Double_t ST_3Err = 0; Float_t ST_3Yield = ST_3_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ST_3Err,"");
	Double_t ST_4Err = 0; Float_t ST_4Yield = ST_4_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ST_4Err,"");*/
	Double_t ST_Err = 0; Float_t ST_Yield = ST_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ST_Err,"");
    /*Double_t ZZ1Err    = 0; Float_t ZZ1Yield  = ZZ1_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZZ1Err, "");
    Double_t ZZ2Err    = 0; Float_t ZZ2Yield  = ZZ2_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZZ2Err, "");
    Double_t ZZ3Err    = 0; Float_t ZZ3Yield  = ZZ3_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),ZZ3Err, "");
    Double_t WZ1Err    = 0; Float_t WZ1Yield  = WZ1_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WZ1Err, "");
    Double_t WZ2Err    = 0; Float_t WZ2Yield  = WZ2_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WZ2Err, "");
    Double_t WZ3Err    = 0; Float_t WZ3Yield  = WZ3_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WZ3Err, "");
    Double_t WW1Err    = 0; Float_t WW1Yield  = WW1_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WW1Err, "");
    Double_t WW2Err    = 0; Float_t WW2Yield  = WW2_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),WW2Err, "");*/
	Double_t VV_Err    = 0; Float_t VV_Yield  = VV_PRE ->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),VV_Err, "");
	Double_t tptzm0700_Err= 0; Float_t tptzm0700_Yield = tptzm0700lh_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),tptzm0700_Err,"");
	Double_t tptzm0900_Err= 0; Float_t tptzm0900_Yield = tptzm0900lh_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),tptzm0900_Err,"");
    Double_t tptzm1400_Err= 0; Float_t tptzm1400_Yield = tptzm1400lh_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),tptzm1400_Err,"");
	Double_t tptzm1700_Err= 0; Float_t tptzm1700_Yield = tptzm1700lh_PRE->IntegralAndError(1,tptzm0700lh_PRE->GetNbinsX(),tptzm1700_Err,"");
	
    if(i==0){
      cout<<endl;
      //cout<<"Plotting "<<name[i]<<endl;
      cout<<"DATA      = "<<data_PRE->Integral()<<" +/- "<<dataErr<<endl;
	...
	sqrt(ZToNuNu_1Err*ZToNuNu_1Err+ZToNuNu_2Err*ZToNuNu_2Err+ZToNuNu_3Err*ZToNuNu_3Err+ZToNuNu_4Err*ZToNuNu_4Err+ZToNuNu_5Err*ZToNuNu_5Err+ZToNuNu_6Err*ZToNuNu_6Err+ZToNuNu_7Err*ZToNuNu_7Err)<<endl;
	  ...
	  cout<<"QCD       = "<<QCD_PRE->Integral()<<" +/- "<<sqrt(QCD_Err*QCD_Err)<<endl;
	  cout<<"WToLNu    = "<<WToLNu_PRE->Integral()<<" +/- "<<sqrt(WToLNu_Err*WToLNu_Err)<<endl;
	  cout<<"TT        = "<<TT_PRE->Integral()<<" +/- "<<sqrt(TT_Err*TT_Err)<<endl;
	  cout<<"ST        = "<<ST_PRE->Integral()<<" +/- "<<sqrt(ST_Err*ST_Err)<<endl;
	  cout<<"Diboson   = "<<VV_PRE->Integral()<<" +/- "<<sqrt(VV_Err*VV_Err)<<endl;
	  cout<<"Total BKG = "<<ZToNuNu_PRE->Integral()+QCD_PRE->Integral()+WToLNu_PRE->Integral()+TT_PRE->Integral()+ST_PRE->Integral()+VV_PRE->Integral()<<" +/- "<<
		  sqrt(ZToNuNu_Err*ZToNuNu_Err+QCD_Err*QCD_Err+WToLNu_Err*WToLNu_Err+TT_Err*TT_Err+ST_Err*ST_Err+VV_Err*VV_Err)<<endl;

	  cout<<"Tprime LH 0700 = "<<tptzm0700lh_PRE->Integral()<<" +/- "<<sqrt(tptzm0700_Err*tptzm0700_Err)<<endl;
	  cout<<"Tprime LH 0900 = "<<tptzm0900lh_PRE->Integral()<<" +/- "<<sqrt(tptzm0900_Err*tptzm0900_Err)<<endl;
	  cout<<"Tprime LH 1400 = "<<tptzm1400lh_PRE->Integral()<<" +/- "<<sqrt(tptzm1400_Err*tptzm1400_Err)<<endl;
	  cout<<"Tprime LH 1700 = "<<tptzm1700lh_PRE->Integral()<<" +/- "<<sqrt(tptzm1700_Err*tptzm1700_Err)<<endl;
	}
  ...
  TCanvas* c1 = new TCanvas("c1","c1",0,0,600,600);
    ...
    TGraphAsymmErrors *gDATA = new TGraphAsymmErrors(data_PRE);	
	...
	y[m]=data_PRE->GetBinContent(m+1)/background_PRE->GetBinContent(m+1);
    ...
    tptzm0900lh_PRE->Draw("samehisto");
    tptzm1700lh_PRE->Draw("samehisto");
    ...
    float maxy=-10;
    float ADD=20;
    for(int ABC=0; ABC<data_PRE->GetNbinsX(); ABC++){
      if(background_PRE->GetBinContent(ABC+1)+ADD>=maxy) maxy=background_PRE->GetBinContent(ABC+1)+ADD;
      if(data_PRE      ->GetBinContent(ABC+1)+ADD>=maxy) maxy=data_PRE      ->GetBinContent(ABC+1)+ADD;
    }
    hs->SetMaximum(maxy);
    ...
    pl2->SetFillColor(0);
    TLegendEntry *ple2 = pl2->AddEntry(data_PRE, "data",  "L"); 
    ple2 = pl2->AddEntry(ZToNuNu_PRE, "Z to NuNu",  "F");
    ple2 = pl2->AddEntry(QCD_PRE, "QCD",  "F");
	ple2 = pl2->AddEntry(WToLNu_PRE, "W to LNu",  "F");
    ple2 = pl2->AddEntry(VV_PRE, "VV (V = Z or W)",  "F");
    ple2 = pl2->AddEntry(ST_PRE, "t#bar{t} and single-top",  "F");
    ple2 = pl2->AddEntry(tptzm0900lh_PRE, "T, M=0.9TeV, #sigma#times100",  "L"); 
    ple2 = pl2->AddEntry(tptzm1700lh_PRE, "T, M=1.7TeV, #sigma#times100",  "L"); 
    pl2->Draw();
...
void MakeHistos(char CUTPre[1000],const char *plot, int BIN,double MIN,double MAX,int JETSyst,
  ...
  TH1F *ZZ1; TH1F *ZZ2; TH1F *ZZ3; TH1F *WZ1; TH1F *WZ2; TH1F *WZ3; TH1F *WW1; TH1F *WW2; 
	...
	double N_tptzm0900lh_err = tptzm0700lh->GetBinError(j)*tptzm0900lh->GetBinError(j);
	double N_tptzm1400lh_err = tptzm0700lh->GetBinError(j)*tptzm1400lh->GetBinError(j);
	double N_tptzm1700lh_err = tptzm0700lh->GetBinError(j)*tptzm1700lh->GetBinError(j);
	...
	//cout<<"N_ZToNuNu err = "<<N_ZToNuNu_err<<endl;
	//cout<<"N_WToLNu err = "<<N_WToLNu_err<<endl;
	//cout<<"N_TT err = "<<N_TT_err<<endl;

	//cout<<"N_ZToNuNu = "<<N_ZToNuNu<<endl;
	//cout<<"N_WToLNu = "<<N_WToLNu<<endl;
	//cout<<"N_TT = "<<N_TT<<endl;

	double N_ZToNuNu_PRE_err = (/*SF1_err*N_ZToNuNu*N_ZToNuNu +*/N_ZToNuNu_err*SF1*SF1);
    double N_WToLNu_PRE_err  = (/*SF2_err*N_WToLNu*N_WToLNu+*/ N_WToLNu_err *SF2*SF2);
	double N_TT_PRE_err      = (/*SF3_err*N_TT*N_TT+*/ N_TT_err*SF3*SF3);

    //cout<<"N_ZToNuNu_PRE err = "<<N_ZToNuNu_PRE_err<<endl;
	//cout<<"N_WToLNu_PRE err = "<<N_WToLNu_PRE_err<<endl;
	//cout<<"N_TT_PRE err = "<<N_TT_PRE_err<<endl;
  
	double N_ZToNuNu_PRE = SF1*N_ZToNuNu;
	double N_WToLNu_PRE  = SF2*N_WToLNu;
	double N_TT_PRE      = SF3*N_TT;
	
	data_func->SetBinError(j,sqrt(N_data_err + data_func->GetBinError(j)*data_func->GetBinError(j)));
	data_func->SetBinContent(j,N_data + data_func->GetBinContent(j));    

    tptzm0700lh_func->SetBinError(j,sqrt(N_tptzm0700lh_err + tptzm0700lh_func->GetBinError(j)*tptzm0700lh_func->GetBinError(j)));
	tptzm0700lh_func->SetBinContent(j,N_tptzm0700lh + tptzm0700lh_func->GetBinContent(j));

	tptzm0900lh_func->SetBinError(j,sqrt(N_tptzm0900lh_err + tptzm0900lh_func->GetBinError(j)*tptzm0900lh_func->GetBinError(j)));
	tptzm0900lh_func->SetBinContent(j,N_tptzm0900lh + tptzm0900lh_func->GetBinContent(j));

	tptzm1400lh_func->SetBinError(j,sqrt(N_tptzm1400lh_err + tptzm1400lh_func->GetBinError(j)*tptzm1400lh_func->GetBinError(j)));
	tptzm1400lh_func->SetBinContent(j,N_tptzm1400lh + tptzm1400lh_func->GetBinContent(j));

	tptzm1700lh_func->SetBinError(j,sqrt(N_tptzm1700lh_err + tptzm1700lh_func->GetBinError(j)*tptzm1700lh_func->GetBinError(j)));
	tptzm1700lh_func->SetBinContent(j,N_tptzm1700lh + tptzm1700lh_func->GetBinContent(j));

	ZToNuNu_func->SetBinError(j,sqrt(N_ZToNuNu_PRE_err + ZToNuNu_func->GetBinError(j)*ZToNuNu_func->GetBinError(j)));
	ZToNuNu_func->SetBinContent(j,N_ZToNuNu_PRE + ZToNuNu_func->GetBinContent(j));

	QCD_func->SetBinError(j,sqrt(N_QCD_err + QCD_func->GetBinError(j)*QCD_func->GetBinError(j)));
	QCD_func->SetBinContent(j,N_QCD + QCD_func->GetBinContent(j));

	WToLNu_func->SetBinError(j,sqrt(N_WToLNu_PRE_err + WToLNu_func->GetBinError(j)*WToLNu_func->GetBinError(j)));
	WToLNu_func->SetBinContent(j,N_WToLNu_PRE + WToLNu_func->GetBinContent(j));

	TT_func->SetBinError(j,sqrt(N_TT_PRE_err + TT_func->GetBinError(j)*TT_func->GetBinError(j)));
	TT_func->SetBinContent(j,N_TT_PRE + TT_func->GetBinContent(j));

	ST_func->SetBinError(j,sqrt(N_ST_err + ST_func->GetBinError(j)*ST_func->GetBinError(j)));
	ST_func->SetBinContent(j,N_ST + ST_func->GetBinContent(j));

	VV_func->SetBinError(j,sqrt(N_VV_err + VV_func->GetBinError(j)*VV_func->GetBinError(j)));
	VV_func->SetBinContent(j,N_VV + VV_func->GetBinContent(j));
	
	background_func->SetBinError(j,sqrt(N_ZToNuNu_PRE_err+N_QCD_err+N_WToLNu_PRE_err+N_TT_PRE_err+N_ST_err+N_VV_err+background_func->GetBinError(j)*background_func->GetBinError(j) ));
	background_func->SetBinContent(j,N_ZToNuNu_PRE+N_QCD+N_WToLNu_PRE+N_TT_PRE+N_ST+N_VV + background_func->GetBinContent(j));
	

 }

  delete data; delete tptzm0700lh; delete tptzm0900lh; delete tptzm1400lh; delete tptzm1700lh;
...
void CalculateSF(char CUTCS1[1000],char CUTCS2[1000],char CUTCS3[1000],const char *plot_CR, int BIN_CR,double MIN_CR,double MAX_CR,
	    ...
	    /*const char *plot, int BIN,double MIN,double MAX,int JETSyst,
  ...
  TH1F *ZZ1_CS3; TH1F *ZZ2_CS3; TH1F *ZZ3_CS3; TH1F *WZ1_CS3; TH1F *WZ2_CS3; TH1F *WZ3_CS3; TH1F *WW1_CS3; TH1F *WW2_CS3; 
	...
	GetHisto(CUTCS1, Tree01, data_CS1        ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree14, ZToNuNu_1_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree15, ZToNuNu_2_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree16, ZToNuNu_3_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree17, ZToNuNu_4_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree18, ZToNuNu_5_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree19, ZToNuNu_6_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree20, ZToNuNu_7_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree21, QCD_1_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree22, QCD_2_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree23, QCD_3_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree24, QCD_4_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree25, QCD_5_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree26, QCD_6_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree27, QCD_7_CS1      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree28, WToLNu_1_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree29, WToLNu_2_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree30, WToLNu_3_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree31, WToLNu_4_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree32, WToLNu_5_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree33, WToLNu_6_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree34, WToLNu_7_CS1   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree35, TT_1_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree36, TT_2_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree37, ST_1_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree38, ST_2_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree39, ST_3_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree40, ST_4_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS1, Tree41, ZZ1_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree42, ZZ2_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree43, ZZ3_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree44, WW1_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS1, Tree45, WW2_CS1    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    ...
    GetHisto(CUTCS2, Tree15, ZToNuNu_2_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree16, ZToNuNu_3_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree17, ZToNuNu_4_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree18, ZToNuNu_5_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree19, ZToNuNu_6_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree20, ZToNuNu_7_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree21, QCD_1_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree22, QCD_2_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree23, QCD_3_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree24, QCD_4_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree25, QCD_5_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree26, QCD_6_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree27, QCD_7_CS2      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree28, WToLNu_1_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree29, WToLNu_2_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree30, WToLNu_3_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree31, WToLNu_4_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree32, WToLNu_5_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree33, WToLNu_6_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree34, WToLNu_7_CS2   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree35, TT_1_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree36, TT_2_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree37, ST_1_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree38, ST_2_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree39, ST_3_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree40, ST_4_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS2, Tree41, ZZ1_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree42, ZZ2_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree43, ZZ3_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree44, WW1_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS2, Tree45, WW2_CS2    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    ...
    GetHisto(CUTCS3, Tree15, ZToNuNu_2_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree16, ZToNuNu_3_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree17, ZToNuNu_4_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree18, ZToNuNu_5_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree19, ZToNuNu_6_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree20, ZToNuNu_7_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree21, QCD_1_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree22, QCD_2_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree23, QCD_3_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree24, QCD_4_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree25, QCD_5_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree26, QCD_6_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree27, QCD_7_CS3      ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree28, WToLNu_1_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree29, WToLNu_2_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree30, WToLNu_3_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree31, WToLNu_4_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree32, WToLNu_5_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree33, WToLNu_6_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree34, WToLNu_7_CS3   ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree35, TT_1_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree36, TT_2_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree37, ST_1_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree38, ST_2_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree39, ST_3_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree40, ST_4_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
    GetHisto(CUTCS3, Tree41, ZZ1_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree42, ZZ2_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree43, ZZ3_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
	GetHisto(CUTCS3, Tree44, WW1_CS3    ,plot_CR,BIN_CR,MIN_CR,MAX_CR);
  ...
  //cout<<"N_WToLNu_CS2 = "<< N_WToLNu_CS2 <<endl;
	...
	float N_TT_PRE_err      = (SF3_err*N_TT_SR*N_TT_SR  +N_TT_SR_err*SF3*SF3);
  
	float N_ZToNuNu_PRE = SF1*N_ZToNuNu_SR;
	float N_WToLNu_PRE  = SF2*N_WToLNu_SR;
	float N_TT_PRE      = SF3*N_TT_SR;*/
    ...
    /*background_CS1->SetBinError(j,sqrt(err01_CS1+err02_CS1+err03_CS1+err04_CS1+err05_CS1+err06_CS1));
	background_CS1->SetBinContent(j,bkg0_CS1+bkg1_CS1+bkg2_CS1+bkg3_CS1+bkg4_CS1+bkg5_CS1);

	background_CS2->SetBinError(j,sqrt(err01_CS2+err02_CS2+err03_CS2+err04_CS2+err05_CS2+err06_CS2));
	background_CS2->SetBinContent(j,bkg0_CS2+bkg1_CS2+bkg2_CS2+bkg3_CS2+bkg4_CS2+bkg5_CS2);

	background_CS3->SetBinError(j,sqrt(err01_CS3+err02_CS3+err03_CS3+err04_CS3+err05_CS3+err06_CS3));
	background_CS3->SetBinContent(j,bkg0_CS3+bkg1_CS3+bkg2_CS3+bkg3_CS3+bkg4_CS3+bkg5_CS3);*/
