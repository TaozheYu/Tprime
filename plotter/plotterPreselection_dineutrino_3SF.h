...
const int N = 11;  Double_t xbins[N] = {200,300,400,500,600,700,800,900,1000,1100,2000};

TH1F *SF1_h   = new TH1F("",  "",  N-1,xbins);
TH1F *SF2_h   = new TH1F("",  "",  N-1,xbins);
TH1F *SF3_h   = new TH1F("",  "",  N-1,xbins);
