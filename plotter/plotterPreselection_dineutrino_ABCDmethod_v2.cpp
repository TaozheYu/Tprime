#include "plotterPreselection_dineutrino_ABCDmethod_v2.h"

void plotterPreselection_dineutrino_ABCDmethod_v2(){ 
  gROOT->Reset();
  ...
  for(int i=0; i<name.size(); i++){
	...
	sprintf(CUT,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==1)&&(Jet1ResolvedPt>0)&&(Jet2ResolvedPt>0)&&(Jet3ResolvedPt>0)&&(TopPt>300)&&(MinDeltaPhiJetMet>0.6))");
	sprintf(CUTB,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==1)&&(Jet1ResolvedPt>0)&&(Jet2ResolvedPt>0)&&(Jet3ResolvedPt>0)&&(TopPt>300)&&(MinDeltaPhiJetMet<0.6))");
	sprintf(CUTC,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==1)&&(Jet1ResolvedPt>0)&&(Jet2ResolvedPt>0)&&(Jet3ResolvedPt>0)&&(TopPt>200)&&(TopPt<300)&&(MinDeltaPhiJetMet>0.6))");
	sprintf(CUTD,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==1)&&(Jet1ResolvedPt>0)&&(Jet2ResolvedPt>0)&&(Jet3ResolvedPt>0)&&(TopPt>200)&&(TopPt<300)&&(MinDeltaPhiJetMet<0.6))");
	//sprintf(CUT,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==0)&&(TopPt>200)&&(MinDeltaPhiJetMet>0.6)&&(Met_pt>200))");
	//sprintf(CUT,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((category0==0)&&(TopPt>200)&&(MinDeltaPhiJetMet<0.6)&&(Met_pt>200))");

	//sprintf(CUT,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*((Jet1ResolvedPt>0)&&(Jet2ResolvedPt>0)&&(Jet3ResolvedPt>0)&&(TopPt>0))");
	//sprintf(CUT,    "PUWeight   *w_for  *w_Btag  *w_topJet  *w_WJet  *genWeight*(TopPt>0)");
	...
	MakeHistos(CUT,CUTB,CUTC,CUTD,plot,bin[i],Min[i],Max[i],0,data_SR,background_SR,ZToNuNu_1_SR,ZToNuNu_2_SR,ZToNuNu_3_SR,ZToNuNu_4_SR,ZToNuNu_5_SR,ZToNuNu_6_SR,ZToNuNu_7_SR,
...
void MakeHistos(char CUT[1000],char CUTB[1000],char CUTC[1000],char CUTD[1000],const char *plot,int BIN,float MIN,float MAX,int JETSyst,
  ...
  if(JETSyst==0){
	...
	GetHisto(CUTB, Tree01, data_B        ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree02, tptzm0700lh_B ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree04, tptzm0900lh_B ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree09, tptzm1400lh_B ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree12, tptzm1700lh_B ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree14, ZToNuNu_1_B   ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree15, ZToNuNu_2_B   ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree16, ZToNuNu_3_B   ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree17, ZToNuNu_4_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree18, ZToNuNu_5_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree19, ZToNuNu_6_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree20, ZToNuNu_7_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree21, QCD_1_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree22, QCD_2_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree23, QCD_3_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree24, QCD_4_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree25, QCD_5_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree26, QCD_6_B      ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree27, QCD_7_B      ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree28, WToLNu_1_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree29, WToLNu_2_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree30, WToLNu_3_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree31, WToLNu_4_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree32, WToLNu_5_B   ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree33, WToLNu_6_B   ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree34, WToLNu_7_B   ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree35, TT_1_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree36, TT_2_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree37, ST_1_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree38, ST_2_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree39, ST_3_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree40, ST_4_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree41, ZZ1_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree42, ZZ2_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree43, ZZ3_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree44, WW1_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree45, WW2_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree46, WZ1_B    ,plot,BIN,MIN,MAX);
    GetHisto(CUTB, Tree47, WZ2_B    ,plot,BIN,MIN,MAX);
	GetHisto(CUTB, Tree48, WZ3_B    ,plot,BIN,MIN,MAX);
	//GetHisto(CUT, Tree49, WToLNu ,plot,BIN,MIN,MAX);

	GetHisto(CUTC, Tree01, data_C        ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree02, tptzm0700lh_C ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree04, tptzm0900lh_C ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree09, tptzm1400lh_C ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree12, tptzm1700lh_C ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree14, ZToNuNu_1_C   ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree15, ZToNuNu_2_C   ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree16, ZToNuNu_3_C   ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree17, ZToNuNu_4_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree18, ZToNuNu_5_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree19, ZToNuNu_6_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree20, ZToNuNu_7_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree21, QCD_1_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree22, QCD_2_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree23, QCD_3_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree24, QCD_4_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree25, QCD_5_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree26, QCD_6_C      ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree27, QCD_7_C      ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree28, WToLNu_1_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree29, WToLNu_2_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree30, WToLNu_3_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree31, WToLNu_4_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree32, WToLNu_5_C   ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree33, WToLNu_6_C   ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree34, WToLNu_7_C   ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree35, TT_1_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree36, TT_2_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree37, ST_1_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree38, ST_2_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree39, ST_3_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree40, ST_4_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree41, ZZ1_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree42, ZZ2_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree43, ZZ3_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree44, WW1_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree45, WW2_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree46, WZ1_C    ,plot,BIN,MIN,MAX);
    GetHisto(CUTC, Tree47, WZ2_C    ,plot,BIN,MIN,MAX);
	GetHisto(CUTC, Tree48, WZ3_C    ,plot,BIN,MIN,MAX);

	GetHisto(CUTD, Tree01, data_D        ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree02, tptzm0700lh_D ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree04, tptzm0900lh_D ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree09, tptzm1400lh_D ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree12, tptzm1700lh_D ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree14, ZToNuNu_1_D   ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree15, ZToNuNu_2_D   ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree16, ZToNuNu_3_D   ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree17, ZToNuNu_4_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree18, ZToNuNu_5_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree19, ZToNuNu_6_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree20, ZToNuNu_7_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree21, QCD_1_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree22, QCD_2_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree23, QCD_3_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree24, QCD_4_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree25, QCD_5_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree26, QCD_6_D      ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree27, QCD_7_D      ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree28, WToLNu_1_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree29, WToLNu_2_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree30, WToLNu_3_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree31, WToLNu_4_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree32, WToLNu_5_D   ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree33, WToLNu_6_D   ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree34, WToLNu_7_D   ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree35, TT_1_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree36, TT_2_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree37, ST_1_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree38, ST_2_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree39, ST_3_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree40, ST_4_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree41, ZZ1_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree42, ZZ2_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree43, ZZ3_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree44, WW1_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree45, WW2_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree46, WZ1_D    ,plot,BIN,MIN,MAX);
    GetHisto(CUTD, Tree47, WZ2_D    ,plot,BIN,MIN,MAX);
	GetHisto(CUTD, Tree48, WZ3_D    ,plot,BIN,MIN,MAX);
  ...
  for(int j=1; j<data->GetNbinsX()+1; j++){
    ...
    background->SetBinError(j,sqrt(err01+err03+err04+err05+err06));
	background->SetBinContent(j,bkg0+bkg2+bkg3+bkg4+bkg5);
  ...
  Double_t QCD_BErr   = 0; Float_t QCD_BYield = QCD_B->IntegralAndError(1,QCD_B->GetNbinsX(),QCD_BErr,"");
  Double_t QCD_CErr   = 0; Float_t QCD_CYield = QCD_C->IntegralAndError(1,QCD_C->GetNbinsX(),QCD_CErr,"");
  Double_t QCD_DErr   = 0; Float_t QCD_DYield = QCD_D->IntegralAndError(1,QCD_D->GetNbinsX(),QCD_DErr,"");

  //cout<<endl;
  //cout<<QCD_B->Integral()<<" +/- "<<sqrt(QCD_BErr*QCD_BErr)<<endl;
  //cout<<QCD_C->Integral()<<" +/- "<<sqrt(QCD_CErr*QCD_CErr)<<endl;
  //cout<<QCD_D->Integral()<<" +/- "<<sqrt(QCD_DErr*QCD_DErr)<<endl;
  //cout<<endl;

  /*QCD_B->Scale(QCD_C->Integral() / QCD_D->Integral());
  for(int i=1; i<data->GetNbinsX()+1; i++){
	  background->SetBinError(i,background->GetBinError(i)+QCD_B->GetBinError(i));
	  background->SetBinContent(i,background->GetBinContent(i)+QCD_B->GetBinContent(i));
  }*/
